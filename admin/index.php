            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Site Overview</a>
                    </div>
                                            ...
                                            while ($req_post = mysqli_fetch_assoc($result_qry)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <hr>
                                                        <a id="block_button" class="text text-danger" href="publisher/block_publisher.php">Block Publisher</a>
