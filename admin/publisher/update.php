            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class=" text-white collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../publisher_insert.php">Add</a>
                    </div>
                </div>
            </li>
                                    ...
                                    <form action="update.php" method="POST" enctype="multipart/form-data">
                                        <div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-baseline">
                                                <a class="btn btn-danger" href="../publisher.php">Cancel</a>
                                                <strong>OR</strong>
                                                <button type="submit" name="Update_publisher"  class="btn btn-primary">Update</button>
                                            </div>
